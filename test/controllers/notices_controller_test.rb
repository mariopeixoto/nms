...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { address: @notice.address, generated_pdf_path: @notice.generated_pdf_path, name: @notice.name }
    end
  ...
  test "should update notice" do
    patch :update, id: @notice, notice: { address: @notice.address, generated_pdf_path: @notice.generated_pdf_path, name: @notice.name }
    assert_redirected_to notice_path(assigns(:notice))
  end
